...
var Player = function (props) {
    return ((0, jsx_runtime_1.jsxs)(material_1.ListItem, { children: [(0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: props.name, secondary: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(material_1.Typography, { children: props.playerStatus }) }) }), (0, jsx_runtime_1.jsxs)(material_1.ListItemIcon, { sx: { alignItems: "center", gap: '.5rem' }, children: [(0, jsx_runtime_1.jsx)(icons_material_1.EmojiEvents, {}), " ", (0, jsx_runtime_1.jsx)(material_1.Typography, { fontWeight: 'bold', variant: 'subtitle2', children: " 0" })] }), (0, jsx_runtime_1.jsxs)(material_1.ListItemIcon, { children: [props.playerStatus === 'Waiting for player to join' && (0, jsx_runtime_1.jsx)(icons_material_1.Pending, { color: 'action' }), props.playerStatus === 'Waiting for player to be ready' && (0, jsx_runtime_1.jsx)(icons_material_1.HourglassEmpty, { color: 'warning' }), props.playerStatus === 'Player ready!' && (0, jsx_runtime_1.jsx)(icons_material_1.ThumbUpAlt, { color: 'success' })] })] }));
};
